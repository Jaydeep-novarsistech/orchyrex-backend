...
const ImageModal = ({ isOpen, onClose }) => {
  return (
    <>
      {isOpen && (
        <div className="fixed mt-[7rem] top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-screen-md max-h-full overflow-y-auto bg-gray-800 bg-opacity-75 z-50">
          <div className="bg-white p-6 sm:p-8 rounded shadow-md mx-auto max-w-full">
            ...
            <div className="max-h-full overflow-y-auto">
              <img
                src={bigchart}
                alt="Modal Image"
                className="w-full lg:block hidden h-auto mb-4 rounded"
              />
              <img
                src={smallchart}
                alt="Modal Image"
                className="w-full lg:hidden h-auto mb-4 rounded"
              />
              ...
              <p className="text-center mb-6">
                Take your actual body measurements as they are more accurate
                than measuring over your clothes.
              </p>
